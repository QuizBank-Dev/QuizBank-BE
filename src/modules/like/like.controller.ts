...
export class LikeController {
	...
	@ApiBaseResponse(201, '변경 성공', toggleLikeEx)
	...
	@ApiBaseResponse(200, '조회 성공', getQuizbookLikeListEx)
	getQuizbookLikeList(
		@Query() dto: PaginationRequestDto,
		@UserId() userId: string,
	) {
		return this.likeService.getQuizbookLikeListByUser(dto, userId);
	}
	...
	@ApiBaseResponse(200, '조회 성공', getQuizLikeListEx)
	getQuizLikeList(
		@Query() dto: PaginationRequestDto,
		@UserId() userId: string,
	) {
		return this.likeService.getQuizLikeListByUser(dto, userId);
	}
}
